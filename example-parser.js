// Input format looks like: [timestamp] type data
// the data field is dependent on the type
(function(in_str) { 
    ...
    if (in_items.length > 2) {
        data_valid = true;
        switch (type_val) {
            // rxdata: handle remaining objects as hex string
            case "rxdata":
...
//console.log(parse("[2020-10-18 09:01:50.141] 110 rxdata 01 72 73"))
